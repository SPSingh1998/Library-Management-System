...
public class STUDENT_PROFILE extends javax.swing.JFrame {
    String id;
    public STUDENT_PROFILE(String c) {
        
        initComponents();
        try
        {
            id=c;
            String qry="select stuname,stuphno,stustream,stusem from tbstudent where stuid='"+id+"'";
            ResultSet rs=new DB().execute(qry);
            rs.next();
            jTextField1.setText(rs.getString("stuname"));
            jTextField2.setText(rs.getString("stuphno"));
            jTextField3.setText(rs.getString("stustream"));
            jTextField4.setText(rs.getString("stusem"));
        }
        catch(Exception e)
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            String qry="update tbstudent set stuname='"+name+"',stuphno='"+phno+"',stustream='"+add+"',stusem="+jTextField4.getText()+" where stuid='"+id+"'";
            new DB().update(qry);
        }
        catch(Exception e)
        {
